...
print('Expected number of changes per hundred residues after 1 PAM, '\
      + 'according to this PAM1 matrix I found by googling:')
print(100 * expected_changes(pam1, pi_ver))
